...
const ProfilePage = () => {
 ...
 <div className="flex-grow flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
  <div className="sm:mx-auto sm:w-full sm:max-w-md">
    <h2 className="mt-6 text-center text-3xl font-extrabold text-grey-900">Your Profile</h2>
  </div>
    ...
    <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-gray-200">
      ...
      <div>
              ...
              {image && (
							...
							<button
								type='submit'
								className='w-full flex justify-center py-2 mt-6 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-yellow-600 hover:bg-yellow-700 
