			...
			<div>
				...
				<div className='mt-1'>
					<input
						...
						min='18'
						max='120'
						className='appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-Yello-500 focus:border-yellow-500 sm:text-sm'
					/>
				</div>
			</div>
